...
const app = express();
app.use(cors({ origin: "https://www.rfcollection999.com" }));
...
router.post("/create-checkout-session", async (req, res) => {
  ...
  try {
    ...
    const data = {
      ...
      mode: "payment",
      products: lineItems,
      success_url: "https://www.rfcollection999.com/SuccessRedirect?client_reference_id=" + nowId,
      cancel_url: "https://www.rfcollection999.com/cancel",
      metadata: {
